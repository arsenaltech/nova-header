...
Nova.booting(function (Vue, router) {
    Vue.component('index-nova-header', __webpack_require__(3));
    Vue.component('detail-nova-header', __webpack_require__(6));
    Vue.component('form-nova-header', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c(
    ...
    [_c("h2", [_vm._v(_vm._s(_vm.field.name))])]
  )
}
var staticRenderFns = []
render._withStripped = true
